  ...
  return (
    <div className="min-h-screen text-white pt-24 pb-12 px-6 relative">
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        <h1 className="text-5xl font-black italic mb-2 text-red-600 uppercase tracking-tighter drop-shadow-lg">Formula 1 <span className="text-white">Schedule</span></h1>
        <p className="text-gray-300 mb-12 text-lg drop-shadow-md">Witness the pinnacle of motorsport at the world’s most iconic circuits.</p>
