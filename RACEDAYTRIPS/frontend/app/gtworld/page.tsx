  ...
  return (
    <div className="min-h-screen text-white pt-24 pb-12 px-6 relative">
      ...
      <div className="fixed inset-0 z-0">
        <img src="/images/gtworld.jpg" alt="GT World Background" className="w-full h-full object-cover opacity-30 blur-[2px]" />
        <div className="absolute inset-0 bg-gradient-to-b from-[#050505]/70 via-[#050505]/90 to-[#050505]"></div>
      </div>

      <div className="max-w-5xl mx-auto relative z-10">
        <h1 className="text-5xl font-black italic mb-2 text-yellow-500 uppercase tracking-tighter drop-shadow-lg">GT World <span className="text-white">Schedule</span></h1>
        <p className="text-gray-300 mb-12 text-lg drop-shadow-md">Witness the most intense GT3 battles on the racetrack.</p>
        ...
        {loading ? (
          ...
          <p className="text-gray-500 italic">GT World schedule is not available yet.</p>
        )}
      </div>
    </div>
  );
